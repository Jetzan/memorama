...
import { createTableEasy, createTableMedium, createTableHard, getValueInTable } from '../utils/generateTable';
...
export const obtenerValor = (req: Request, res: Response) => {
  ...
  if (x < 0 || y < 0 || x >= tableroActual.length || y >= tableroActual[0].length) {
